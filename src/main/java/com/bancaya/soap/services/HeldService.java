...
public class HeldService implements HeldServiceI {

    @Autowired
    RequestDAO requestDao = new RequestDAO();

    @Override
    public String getHeld(String pokemon, String ipAddress){

        String result = "";
        final String uri = APIREST_URI_ABILITY;

        Request request = new Request(ipAddress, "held");
        ...
        try {
            ...
            result = node.get("held_items").toString();

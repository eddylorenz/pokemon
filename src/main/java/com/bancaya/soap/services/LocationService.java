...
public class LocationService implements LocationServiceI {
    ...
    @Override
    public String getLocation(String pokemon, String ipAddress){

        String result = "";
        final String uri = APIREST_URI_ABILITY;

        Request request = new Request(ipAddress, "location");
        ...
        try {
            ...
            result = node.get("location_area_encounters").toString();
